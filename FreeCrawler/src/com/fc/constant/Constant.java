...
public class Constant {
    ...
    // 程序图标
    public static final String CRAWLER_STEP = CONFIG_PATH + File.separator + "img/step.png";
    // 登陆页面
    public static final String CRAWLER_LOGIN_BG = CONFIG_PATH + File.separator + "img/login_bg.png";
